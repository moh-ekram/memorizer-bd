...
export default function RevisionCenter({
  ...
  return (
    <div className="space-y-3 sm:space-y-6 max-w-5xl mx-auto px-1.5 sm:px-4 py-2 sm:py-4" style={{ fontFamily: "'Poppins', sans-serif" }}>
      ...
      <div className="bg-gradient-to-r from-emerald-900 via-teal-900 to-indigo-950 text-white rounded-2xl p-3 sm:p-5 shadow-md relative overflow-hidden border border-emerald-500/20">
        <div className="relative z-10 space-y-2">
          <div className="flex items-center gap-1.5 sm:gap-2">
            <span className="px-2 py-0.5 sm:px-2.5 sm:py-1 bg-emerald-500/20 text-emerald-300 border border-emerald-400/30 font-extrabold text-[9px] sm:text-[10px] rounded-full uppercase tracking-wider flex items-center gap-1 backdrop-blur-md">
              <RotateCcw className="w-3 h-3 text-emerald-400" /> Revision
            </span>
            <span className="text-[10px] sm:text-xs font-mono text-emerald-200/80">• Know Words ({knowWords.length})</span>
          </div>
