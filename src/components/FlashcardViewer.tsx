...
export default function FlashcardViewer({
  ...
  useEffect(() => {
    ...
    if (selectedGroups.length < uniqueGroups.length) {
      result = result.filter(w => selectedGroups.some(g => String(g) === String(w.group)));
    }
                        ...
                        <button
                          ...
                          onClick={() => {
                            setSelectedGroups(prev => {
                              const exists = prev.some(x => String(x) === String(gVal));
                              if (exists) {
                                return prev.filter(x => String(x) !== String(gVal));
                              } else {
                                return [...prev, gVal];
                              }
                            });
