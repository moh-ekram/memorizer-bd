    ...
    <div className="space-y-8 w-full max-w-6xl mx-auto pb-12" style={{ fontFamily: "'Poppins', sans-serif" }}>
      ...
      {activeArticleIndex === null && (
        <div className="space-y-8">
          ...
          {/* Header Banner */}
          <div className="bg-white p-6 sm:p-8 rounded-2xl border border-slate-200/80 space-y-1.5 shadow-2xs">
            <h1 className="text-xl sm:text-2xl font-bold tracking-tight text-slate-900">
              Interactive Articles
            </h1>
            <p className="text-xs sm:text-sm text-slate-500 font-normal">
              Read curated articles to build vocabulary.
            </p>
          </div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
              ...
              <div className="relative w-full sm:w-80">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 bg-slate-50 border border-slate-200/80 rounded-xl text-xs font-medium text-slate-800 placeholder-slate-400 focus:outline-none focus:border-indigo-500 transition"
                />
                {searchQuery && (
                  <button
